          ...
          addedPhotos.map((link) => (
            <div className='h-32 flex relative' key={link}>
              ...
              <button
                ...
                className='absolute bottom-1 right-1 text-white bg-black py-1 px-2 bg-opacity-50 rounded-2xl'
              >
                {trashIcon}
              </button>
              <button
                onClick={(e) => selectAsMainPhoto(e, link)}
                className='absolute bottom-1 left-1 text-white bg-black py-1 px-2 bg-opacity-50 rounded-2xl'
              >
                {(link === addedPhotos[0] && starIconSolid) || starIconOutline}
              </button>
            </div>
          ))}
